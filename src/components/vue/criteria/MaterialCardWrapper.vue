<script setup lang="ts">
    ...
    const elements: ElementCardProps[] = data;
...
<template>
    <div
        class="flex flex-col md:flex-row gap-4 md:gap-10 xl:gap-32 justify-center items-center xl:h-full h-screen p-8 pt-16 xl:pt-8">
